...
public static class WorldRuleCatalog
{
    ...
    [
        new()
        {
            Key = "gameMode", LabelZh = "游戏模式", Type = WorldRuleType.Choice,
            Choices = ["survival", "creative"], DefaultValue = "survival"
        },
        new() { Key = "playerlives", LabelZh = "玩家生命次数", Type = WorldRuleType.Text },
        new()
        {
            Key = "creatureHostility", LabelZh = "生物敌对性", Type = WorldRuleType.Choice,
            Choices = ["aggressive", "passive", "off"], DefaultValue = "aggressive"
        },
        new()
        {
            Key = "temporalStorms", LabelZh = "时空风暴频率", Type = WorldRuleType.Choice,
        ...
        new()
        {
            Key = "allowCoordinateHud", LabelZh = "允许坐标 HUD", Type = WorldRuleType.Boolean, DefaultValue = "true"
        },
        new()
        {
            Key = "allowLandClaiming", LabelZh = "允许领地声明", Type = WorldRuleType.Boolean, DefaultValue = "true"
        },
        ...
        new()
        {
            Key = "worldEdge", LabelZh = "世界边界类型", Type = WorldRuleType.Choice,
